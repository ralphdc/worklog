...
{
    $javahome = 'http://172.20.0.115:8080'; //李超群
	//$javahome = 'http://172.17.6.180:8080';//李超群环境
...
return array(
    ...
    //韦工测试环境
    'loginRequest'=>'http://172.20.12.205:8080/wcp/login/ajaxsubmit.do' , 
    //韦工测试环境；
    'loginMenu'=>'http://172.20.12.205:8080/wcp/actiontree/myMenus.do',
    'loginPWD'=>'http://172.20.12.205:8080/wcp/user/modifyPassword.do' ,
    
    //存储登录菜单;
    'localRedisHost'=>'172.17.4.203',
    'localRedisHostPort'=>'6379'
