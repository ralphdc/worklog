...
return array(
	...
	//调用java的接口存数据库 韦庆丁
	'TohostSerqulityUrl' 			=>'http://172.17.3.97:10056',//本地环境http://172.20.0.20:8080//开发环境http://172.20.4.1:8888
	//调用java的接口通知容器服务 阳海涛
	'TotradeUrl' 				=>'http://172.20.5.55:8080/container/containerService/',//本地环境http://172.20.0.108:8080/container/containerService/
	//调用渠道切换的接口 李小泉
	//'TochannelUrl'				=>'http://172.20.0.27:8801/',//本地环境http://172.20.0.27:8801//开发环境172.17.6.59:10499 
	
	'TochannelUrl'				=>'http://172.20.0.27:8801/',
	//流水监控接口 唐春苗
	//'TowatermoniUrl'			=>'http://172.17.3.97:10056',//测试环境http://172.17.6.180:8080//唐春苗http://172.20.0.33:8080
    'TowatermoniUrl'			=>'http://172.17.3.97:10056',
	
	//ICE权重和权重服务  2015-11-16 ICE权重、权重服务改造，对接人：李超群；
	'ToiceweightUrl'			=>'http://172.17.3.88:10057',//本地环境http://172.20.0.33:8080//测试环境http://172.17.3.86:8081
	//登录
