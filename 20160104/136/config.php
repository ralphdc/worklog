<?php
//流水数据监控redis的服务地址
$GLOBALS['RedisServerConf']	 ='172.20.5.56';//'172.17.6.56';//redis的服务地址
...
return array(
	...
	//调用java的接口存数据库 韦庆丁
	'TodatabaseUrl' 			=>'http://172.17.6.80:10056',//本地环境http://172.20.0.20:8080//开发环境http://172.20.4.1:8888
	//调用java的接口通知容器服务 阳海涛
	'TotradeUrl' 				=>'http://172.20.0.108:8080/container/containerService/',//本地环境http://172.20.0.108:8080/container/containerService/
	//调用渠道切换的接口 李小泉
	'TochannelUrl'				=>'http://172.30.2.138:8801/',//本地环境http://172.20.0.27:8801//开发环境172.17.6.59:10499 
	//流水监控接口 唐春苗
	'TowatermoniUrl'			=>'http://172.17.6.80:10056',//测试环境http://172.17.6.180:8080//唐春苗http://172.20.0.33:8080
	//ICE权重和权重服务
	'ToiceweightUrl'			=>'http://172.17.3.118:10057',//本地环境http://172.20.0.33:8080//测试环境http://172.17.3.86:8080
	//登录
